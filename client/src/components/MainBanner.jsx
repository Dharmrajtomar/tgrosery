...
import homebanner from "../pics/home-img.jpeg";
      ...
      >
        ...
        <div className="flex items-center mt-6 font-medium">
          ...
          >
            Shop now
            <img
              className="md:hidden transition group-focus:translate-x-1 w-5 "
          ...
          <Link
            to={"/products"}
            className="group hidden md:flex items-center gap- px-9 py-3
              cursor-pointer "
          >
            Explore deals
            <img
              className=" transition group-hover:translate-x-1 w-5"
              src="arrow.png"
              alt="arrow"
            />
          </Link>
